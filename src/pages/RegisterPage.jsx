...
import { doc, setDoc } from "firebase/firestore"; // เพิ่ม setDoc และ doc
...
//////////////////////////////////////////////////////////////////////
    ...
    const [rank,setRank] = React.useState('ผู้เริ่มต้น');
    ...
    <Box>
      ...
      <Box sx={{ p: 2 }} marginTop={6}>
        ...
        <Typography variant="h6" sx={{ textAlign: 'left' }}>
            ...
            <Autocomplete
      id="country"
      sx={{ width: 200,marginTop:-5,marginLeft:13 }}
      options={countries}
      autoHighlight
      value={country}
